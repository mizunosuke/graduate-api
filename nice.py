...
# 色相、彩度、明度の範囲を指定
lower_color1 = np.array([0, 45, 30])
upper_color1 = np.array([60, 200, 200]) # 変更
lower_color2 = np.array([180, 10, 10])
upper_color2 = np.array([40, 100, 100])
...
# 面積が小さい輪郭を除外
contours = [cnt for cnt in contours if cv2.contourArea(cnt) > 800]
